...
public:
	...
	// Source Texture
	void RenderEffect(ImageSpaceEffect* apEffect, NiDX9Renderer* apRenderer, NiTexture* apSourceTarget, BSRenderedTexture* apDestTarget, ImageSpaceEffectParam* apParam, bool abEndFrame);
	void RenderEffect(ImageSpaceManager::EffectID aeID, NiDX9Renderer* apRenderer, NiTexture* apSourceTarget, BSRenderedTexture* apDestTarget, ImageSpaceEffectParam* apParam, bool abEndFrame);
